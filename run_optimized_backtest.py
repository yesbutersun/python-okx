...
def main():
    ...
    for strategy_name in strategy_list:
        try:
            print(f"\n回测策略: {strategy_name}...")
            # 直接使用优化策略
            from optimized_strategies import OPTIMIZED_STRATEGIES
...
def save_detailed_results(results):
    ...
    with open('backtest_results/optimized_summary.json', 'w', encoding='utf-8') as f:
        json.dump(summary, f, indent=2, ensure_ascii=False, default=str)

    print("优化策略详细结果已保存到 backtest_results/ 目录")
